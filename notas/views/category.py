...
from notas.models               import Category
from notas.serializers.category import CategorySerializer
from notas.permissions          import IsStaffOrReadOnly
from notas.filters              import CategoryFilter
...
class CategoryViewSet(viewsets.ModelViewSet):
    ...
    def active_products(self, request, pk=None):
        ...
        from notas.serializers.product import ProductSummarySerializer
